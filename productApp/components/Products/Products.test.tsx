...
import { StoreProvider } from '../../../storeApp/redux/store';
import { Provider } from 'react-redux';
import { configureStore } from '@reduxjs/toolkit';
const mockBooks = {products: [
  {
...
jest.mock('store/StoreApp', () => ({
  useStore: jest.fn(() => (
    { books: mockBooks,
       setProducts: () => (console.log("setProducts")),
        useGetBooksQuery: () => ({ data: mockBooks.products, isLoading: false, isSuccess: true }),
        addToCart: () => console.log('dispatc'),
        cart: mockBooks }) )
}),   { virtual: true }
)
...
it('loads and displays ProductList', async () => {
